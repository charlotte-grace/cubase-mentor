...
Trigger: the user explicitly says they want to move to a new track.
1. Ask the one honest question: "Has this track run its course, or is this avoiding
   the part that's currently hard?" Either answer is accepted — it must simply be answered.
2. Shelve per memory contract (`archive/<track-name>-shelved.md` + resume block).
3. Run normal intake for the new track.
A casually mentioned exciting reference is NOT a switch — park it in Next up.

## "Done-enough"

M4 deliberately says done-enough, not perfect. Finished-and-flawed beats polished-and-
abandoned; the next track is where the next lesson lives.
